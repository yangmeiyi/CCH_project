...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768):
        ...
        assert img_size[0] % patch_size[0] == 0 and img_size[1] % patch_size[1] == 0, \
            print("img_size {} should be divided by patch_size {}".format(img_size,patch_size))
...
class CMT(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=2, embed_dims=[46, 92, 184, 368], stem_channel=16,
        ...
        # self.stem_conv4 = nn.Conv2d(32, 3, kernel_size=3, stride=1, padding=1, bias=True)
        ...
        self.last_fc = nn.Linear(fc_dim, 128)
...
@register_model
def cmt_ti(pretrained=True, **kwargs):
    """
    CMT-Tiny
    """
